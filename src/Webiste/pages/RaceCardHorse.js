    ...
    <div className="RaceDetailCard">
      <div className="horseheader1">
        <div className="horseshirt">
          <img
            src={
              !data.data.ActiveOwnerData
                ? DefaultImg
                : data.data.ActiveOwnerData.image
            }
            alt=""
        ...
        <div className="horsecenterdata">
          ...
          >
            ...
            <img
              src={
                data.data.HorseModelIdData1.NationalityData.image
                  ? data.data.HorseModelIdData1.NationalityData.image
                  : DefaultImg
              }
              alt=""
              style={{ height: "18px", margin: "0px 10px" }}
            />
            <p
              style={{
                fontSize: "12px",
            ...
            >
              {data.data.HorseModelIdData1.DOB === null ? (
                <>No Data</>
              ) : (
                <>
                  <Moment fromNow ago>
                    {data.data.HorseModelIdData1.DOB}
                  </Moment>
                </>
              )}{" "}
          ...
          >
            ...
            >
              <b>O </b>
              {cookiedata === "en" ? (
                data.data.OwnerOnRaceData1 === null ? (
                  <></>
                ) : (
                  data.data.OwnerOnRaceData1.NameEn
                )
              ) : data.data.OwnerOnRaceData1 === null ? (
                <></>
              ) : (
                data.data.ActiveOwnerData.NameAr
              )}
            </p>
            <p
              style={{
          ...
          <div className="horsedetailimage">
            <img
              src={
                data.data.TrainerOnRaceData1.image
                  ? data.data.TrainerOnRaceData1.image
                  : DefaultImg
              }
              alt=""
            ...
            <span>
              ...
              >
                ...
                {cookiedata === "en" ? (
                  data.data.TrainerOnRaceData1 === null ? (
                    <></>
                  ) : (
                    data.data.TrainerOnRaceData1.NameEn
                  )
                ) : data.data.TrainerOnRaceData1 === null ? (
                  <></>
                ) : (
                  data.data.ActiveTrainerData.NameAr
                )}{" "}
                (8 - 3 - 2 - 8 - 4)
              </p>
              <p
              ...
              >
                ...
                {cookiedata === "en" ? (
                  data.data.HorseModelIdData1.BreederData === null ? (
                    <></>
                  ) : (
                    data.data.HorseModelIdData1.BreederData.NameEn
                  )
                ) : data.data.HorseModelIdData1.BreederData === null ? (
                  <></>
                ) : (
                  data.data.BreederData.NameAr
                )}
              </p>
            </span>
          </div>
        ...
        <div className="horseimage">
          <img
            src={data.data.HorseImage ? data.data.HorseImage : DefaultImg}
            alt=""
          />
          <button style={btnNew1} onClick={() => handleTrack(data.data._id)}>
            {t("Track")}
          </button>
        </div>
      </div>
                    ...
                    <div className="three">
                      ...
                      <div className="ggdam pedigreeclass">
                        {Pedigree.generation3b === null ? (
                          ...
                          <>N/A</>
                        ) : Pedigree.generation3b.DamData.NameEn === null ? (
                          <>N/A</>
                        ) : (
