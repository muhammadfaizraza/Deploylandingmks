    ...
    <>
      ...
      <Zoom>
        <div className="RaceCardDetail">
          {
            singlerace.length !== 0 ? <div className="RaceDetailHeader">
            <div>
              ...
              <p className="itemtime">{singlerace[0].DayNTime}</p>
                ...
                <div className="itemraces">
                  <div className="inner_itemraces">
                    ...
                    <span className="itemraces_center">
                      <h5><b> {singlerace[0].raceName}</b></h5>
                      <div
                        style={{
                          display: "flex",
                      ...
                      >
                        <p style={{
                          padding: '5px'
                        }}>{singlerace[0].RaceKind}</p>
                        <p style={{
                          padding: '5px'
                        }}>{singlerace[0].RaceStatus}</p>
                        <p style={{
                          padding: '5px'
                        }}>{singlerace[0].Weather}</p>
                      </div>
                    </span>
                    <span className="itemraces_right">
                      <span className="distance">{singlerace[0].DayNTime}</span>
              ...
              >
                ...
                <Tab
                  ...
                  tabClassName="profile-tabitem"
                >
                  <div className="RaceDetailCard"></div>
                </Tab>
                <Tab
                  eventKey="Draw"
                  title="Draw"
                ...
                >
                   <div className="RaceDetailCard">
                    <div className="forfexclass">
                      <Accordion defaultActiveKey="1">
                        <div>
                          <Accordion.Item eventKey={singlerace[0].Horses._id}>
                            <Accordion.Header>
                              <div className="cardracesAccordion">
                                <div className="cardraces1">
                                  <img src={shirt} alt="" />
                                ...
                                <div className="cardraces2">
                                  <div style={{ display: "flex", gap: "10px" }}>
                                    ...
                                    >
                                      {singlerace[0].Horses.map((data) => data.NameEn)}
                                    </p>
                                    <p style={myPara}>{singlerace[0].Horses.map((data) => data.Age)} (242)</p>
                                  </div>
                                  <div
                                    style={{
                                      display: "flex",
                                  ...
                                  >
                                    <p style={myPara}>
                                      <b>Dam</b> :{singlerace[0].Horses.map((data) => data.Dam)}
                                    </p>
                                    <p style={myPara}>
                                      <b>Sire</b> :{singlerace[0].Horses.map((data) => data.Sire)}
                                    </p>
                                    <p style={myPara}>
                                      <b>G.Sire</b> : {singlerace[0].Horses.map((data) => data.GSire)}
                                    </p>
                                  </div>
                                  <div
                                    style={{
