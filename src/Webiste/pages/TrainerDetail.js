            ...
            <div className="horsecenterdata">
              ...
              >
                ...
                > {t("Title")}
                  <b style={{
                    paddingLeft: "5px"
                  }}> {cookiedata === "en" ? (data.data.TitleEn ? data.data.TitleEn : "N/A") : (data.data.TitleAr ? data.data.TitleAr : "N/A")}</b>
                </p>
                <p
                  style={{
                    fontSize: "10px",
              ...
              <div className="horsedetailimage">
                ...
                <span>
                  ...
                  >
                    ...
                    }}>{t("Nationality")}</b>{data.data.TrainerNationalityData ? data.data.TrainerNationalityData.NameEn : <></>}
                  </p>
                  <p
                    style={{
                      fontSize: "12px",
              ...
              <span className="detailsForm">
                <p>{cookiedata === "en" ? (data.data.DetailEn ? data.data.DetailEn : "N/A") : (data.data.DetailAr ? data.data.DetailAr : "N/A")}</p>
              </span>
            </div>
